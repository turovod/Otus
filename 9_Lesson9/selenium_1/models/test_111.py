...
driver = webdriver.Chrome(executable_path='/Users/s.loginov/Desktop/Otus/7_work_with_webelements/Test_Opencart/Drivers/chromedriver')
...
for d in doc:
    ...
    ActionChains(driver).pause(1).move_to_element(d).click_and_hold().move_to_element(trash).perform()
driver.quit()